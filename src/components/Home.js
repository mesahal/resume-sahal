    ...
    <section className="relative min-h-screen flex items-center justify-center py-20 px-4 overflow-hidden">
      ...
      <div className="container mx-auto text-white">
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          {/* Right Side - Roles */}
          <div
            className={`lg:w-3/5 transform transition-all duration-1000  ${
              showRoles
          ...
          >
            <div className="p-6 backdrop-blur-sm">
              <div className="flex flex-col gap-6 text-7xl">
                {showRoles && (
                  <RoleSlideshow
                    roles={roles}
                    currentIndex={currentRoleIndex}
                    setCurrentIndex={setCurrentRoleIndex}
                  />
                )}
              </div>
            </div>
...
const RoleSlideshow = ({ roles, currentIndex, setCurrentIndex }) => {
  ...
  useEffect(() => {
    ...
    const typeText = () => {
      ...
      if (currentText.length < targetText.length) {
        ...
        // console.log("Done Typing", currentIndex);
      }
    };
